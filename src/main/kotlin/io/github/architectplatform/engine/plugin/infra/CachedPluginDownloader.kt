package io.github.architectplatform.engine.plugin.infra

import io.github.architectplatform.engine.plugin.app.PluginDownloader
...
@Singleton
class CachedPluginDownloader : PluginDownloader {
