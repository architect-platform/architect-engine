...
@Singleton
class ProjectContextLoader(private val contextParser: ContextParser) {

	fun getContext(projectPath: String): Context {
		val yamlContext = getExternalConfiguration(projectPath)
